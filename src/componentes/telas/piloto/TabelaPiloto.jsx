...
function TabelaPiloto() {
    ...
    return (
        <div style={{ padding: '20px' }}>
            <h1 className="header-title">Pilotos</h1>
                    ...
                    <table className="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Tipo da Licença</th>
                        ...
                        <tbody>
                            {
                                listaObjetos.map(objeto => (
                                    <tr key={objeto.codigo}>
                                        ...
                                        <td>{objeto.nome}</td>
                                        <td>{objeto.numeroLicenca}</td>
                                        <td>{objeto.tipoLicenca}</td>
                                        <td>{formatDate(objeto.dataNascimento)}</td>
                                        <td>{objeto.anosExperiencia}</td>
                                    </tr>
                                ))
                            }
                        </tbody>
